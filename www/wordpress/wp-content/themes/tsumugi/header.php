	...
	<div class="container">
		...
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) : ?>
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><i class="fa fa-info-circle"></i><br class="hidden-md-up"><?php bloginfo( 'name' ); ?></a></h1>
			<?php else : ?>
				<p class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><i class="fa fa-info-circle"></i><br class="hidden-md-up"><?php bloginfo( 'name' ); ?></a></p>
			<?php
			endif;
